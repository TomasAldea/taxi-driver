  ...
  return (
    <div id="inicio" className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <img src="images/taxiteslamodels.png" alt="" className='absolute bottom-0 right-0 -z-10 mb:-bottom-16'/>
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 mb:pt-20">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ¿Necesitas un presupuesto a medida?
              <a href="#" className="ml-1 font-semibold text-sabagreen-50">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#" className="flex flex-row rounded-md bg-sabagreen-50 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-sabagreen-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2">

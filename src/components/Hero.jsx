  ...
  return (
    <div id="inicio" className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <img src="images/taxiteslamodels.webp" alt="" className='absolute bottom-0 right-0 -z-10 mb:-bottom-16' data-aos-duration="400" data-aos="fade-in" data-aos-offset="0" loading="lazy"/>

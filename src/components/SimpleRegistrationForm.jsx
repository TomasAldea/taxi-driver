    ...
    >
      ...
      <form className="mt-8 mb-2 xl:w-1/2 mb:w-full">
        <div className="mb-4 flex flex-col gap-6">
          <Input name="nombre" labelProps={{ htmlFor: "nombre" }} size="lg" label="Nombre y Apellidos" className="shadow-xl"/>
          <Input name="email" labelProps={{ htmlFor: "email" }} size="lg" label="Email" className="shadow-xl" />
          <Input
